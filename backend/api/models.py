...
class Friend(BaseModel):
    ...
    """
    unique_id: str = Field(...,
                           description="Unique identifier (DNS name:animal name)")
    dns_name: str = Field(...,
                          description="DNS hostname of the friend instance")
    name: str = Field(..., description="Animal name of the friend")
    connected_at: datetime = Field(
        default_factory=datetime.utcnow, description="When the friendship was established")
...
class Animal(BaseModel):
    ...
    species: str = Field(...,
                         description="The type of animal (e.g., 'Red Panda', 'Arctic Fox')")
    description: str = Field(...,
                             description="A brief description of this animal")
    instance_url: str = Field(...,
                              description="The URL where this FurNet instance is hosted")
    ...
    fun_fact: Optional[str] = Field(
        None, description="An interesting fact about this animal")
    emoji: Optional[str] = Field(
        None, description="Emoji representation of the animal")
    color: Optional[str] = Field(
        None, description="Primary color associated with this animal")
